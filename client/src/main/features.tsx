        ...
        <section className='bg-white dark:bg-gray-900'>
          <div className='grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12'>
            <div className='mr-auto place-self-center lg:col-span-7'>
              ...
              <a
                href='#'
                className='bg-[#eb427e] flex w-44 pl-8 pr-8 pt-3 pb-3 rounded-xl hover:bg-transparent hover:border border-white hover:text-black hover:no-underline'
              >
                Get started
                <svg
            ...
            <div className='hidden lg:mt-0 lg:col-span-5 lg:flex'>
              <img
                src='https://img.freepik.com/free-vector/development-concept-illustration_114360-463.jpg?w=740&t=st=1702983802~exp=1702984402~hmac=7bdf4b075161fd53acde8997a106e7629dd784287e731b8f8f730fc1ed3c7f11'
                alt='mockup'
              />
            </div>
          </div>
